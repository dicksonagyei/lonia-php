<?php
     ...
     if(isset($_POST['prompt'])){
            ...
            $data = array(
                "model" => "gpt-3.5-turbo",
                "messages" => array(
                    array('role' => 'system', 'content' => 'You are Lonia. Your only response is strictly numbers from 1 to 5. No other characters. Just 1, 2, 3, 5 and 5. Your response should always be a single number only. Your response should be one character long'),
                    array('role' => 'system', 'content' => '1 for very bad. 2 for bad. 3 for neutral. 4 for good. 5 for very good. If you cannot analyse respond with: 0'),
                    array('role' => 'user', 'content' => 'Analyse this customer feedback and give your number'.$prompt)
                )
            );
...
-->       
              ...
              <?php 
                ...
                if(isset($response)){
                    ...
                    '<div class="container d-flex justify-content-center">
                        ...
                        <script>location.href = "#response";</script>
                        ';
                    }else{
                    echo '...';
                } 
  ...
  <!-- Go to Top -->
  <a class="js-go-to duik-go-to" href="javascript:;" style="background: green;">
